...
minmax.title("alpha beta  Esay")
minmax.geometry("800x600")
...
Label_0 = Label(minmax, text=str(p()), font='0')
...
def check_win():
    if diagonal_check_1() == 1:
        Label2 = Label(minmax, text="1 win", font='20')
        Label2.place(x=350, y=350)

    elif diagonal_check_1() == 2:
        Label3 = Label(minmax, text="2 win", font='20')
        Label3.place(x=350, y=350)

    elif diagonal_check_2() == 1:
        Label4 = Label(minmax, text="1 win", font='20')
        Label4.place(x=350, y=350)
    elif diagonal_check_2() == 2:
        Label5 = Label(minmax, text="2 win", font='20')
        Label5.place(x=350, y=350)

    elif row_check() == 1:
        Label6 = Label(minmax, text="1 win", font='20')
        Label6.place(x=350, y=350)

    elif row_check() == 2:
        Label7 = Label(minmax, text="2 win", font='20')
        Label7.place(x=350, y=350)

    elif colo_check() == 1:
        Label8 = Label(minmax, text="1 win", font='20')
        Label8.place(x=350, y=350)
    elif colo_check() == 2:
        Label9 = Label(minmax, text="2 win", font='20')
...
def ev1():
    ...
    for i in range(5, -1, -1):
        if grid[int(i)][int(colo)] == 1 or grid[int(i)][int(colo)] == 2:
            ...
            break
    Label1 = Label(minmax, text=p(), font='0')
...
label0 = Label(minmax, text="Grid", font='5')
label0.place(x=350, y=0)


bt = Button(minmax, command=ev1,
